...
// import {   getAdminlogin } from '../Redux/Authentication/action'
...
export const AdminLogin = () => {
  ...
  const [adminlogin,setAdminLogin] = useState<AdminType>({
    email : "",
    password : ""
  })

  const dispatch:Dispatch<any> = useDispatch()
  const {admindata}  = useSelector((store:any)=>store.adminReducer)
