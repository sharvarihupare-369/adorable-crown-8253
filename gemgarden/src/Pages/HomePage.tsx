    ...
    <Box m="30px">
     ...
     <Box  w="90%" m="70px auto" >
      ...
      <Carousel autoPlay stopOnHover={true} showArrows={false} showThumbs={false} emulateTouch infiniteLoop showIndicators={false} axis="horizontal">
                ...
                <div>
                    <img  style={{width:"100%"}} src={carousal3img} alt='img'/>             
                </div>
                <div>
                    <img  style={{width:"100%" ,height:"520px"}}  src={carousal2img} alt='img'/>    
                </div>
                <div>
                    <img  style={{width:"100%" ,height:"520px"}}  src={carousal4img} alt='img'/>      
                </div>
                <div>
                    <img  style={{width:"100%" ,height:"520px"}}  src={carousal5img} alt='img'/>      
                </div>
            </Carousel>
       </Box>
      </Flex>
